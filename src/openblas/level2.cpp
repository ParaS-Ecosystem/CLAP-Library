...
void OpenBlasBackend::gemv(Layout layout, Transpose trans,
                           int64_t m, int64_t n,
                           const float alpha, const float *A, int64_t lda,
                           const float *x, int64_t incx,
                           const float beta, float *y, int64_t incy)
{
    clap_cblas_sgemv(to_cblas_order(layout), to_cblas_trans(trans),
                     (int)m, (int)n,
                     alpha, A, (int)lda,
                     x, (int)incx,
                     beta, y, (int)incy);
...
{
    clap_cblas_dgemv(to_cblas_order(layout), to_cblas_trans(trans),
                     (int)m, (int)n,
                     alpha, A, (int)lda,
                     x, (int)incx,
                     beta, y, (int)incy);
...
void OpenBlasBackend::symv(Layout layout, Uplo uplo,
                           int64_t n,
                           const float alpha, const float *A, int64_t lda,
                           const float *X, int64_t incx,
                           const float beta, float *Y, int64_t incy)
{
    clap_cblas_ssymv(to_cblas_order(layout), to_cblas_uplo(uplo),
                     (int)n,
                     alpha, A, (int)lda,
                     X, (int)incx,
                     beta, Y, (int)incy);
...
void OpenBlasBackend::symv(Layout layout, Uplo uplo,
                           ...
                           const double beta, double *Y, int64_t incy)
{
    clap_cblas_dsymv(to_cblas_order(layout), to_cblas_uplo(uplo),
                     (int)n,
                     alpha, A, (int)lda,
                     X, (int)incx,
                     beta, Y, (int)incy);
...
void OpenBlasBackend::trmv(Layout layout, Uplo uplo,
                           ...
                           float *X, int64_t incX)
{
    clap_cblas_strmv(to_cblas_order(layout), to_cblas_uplo(uplo),
                     to_cblas_trans(trans), to_cblas_diag(diag),
                     (int)n, A, (int)lda,
                     X, (int)incX);
}
...
void OpenBlasBackend::trsv(Layout layout, Uplo uplo,
                           Transpose trans, Diag diag,
                           int64_t n, const float *A, int64_t lda,
                           float *X, int64_t incX)
{
...
void OpenBlasBackend::sbmv(Layout layout, Uplo uplo,
                           int64_t n, int64_t k,
                           const float alpha, const float *A, int64_t lda,
                           const float *x, int64_t incX,
                           const float beta, float *y, int64_t incY)
{
    clap_cblas_ssbmv(to_cblas_order(layout), to_cblas_uplo(uplo),
                     (int)n, (int)k,
                     alpha, A, (int)lda,
                     x, (int)incX,
                     beta, y, (int)incY);
...
void OpenBlasBackend::sbmv(Layout layout, Uplo uplo,
                           ...
                           const double beta, double *y, int64_t incY)
{
    clap_cblas_dsbmv(to_cblas_order(layout), to_cblas_uplo(uplo),
                     (int)n, (int)k,
                     alpha, A, (int)lda,
                     x, (int)incX,
                     beta, y, (int)incY);
